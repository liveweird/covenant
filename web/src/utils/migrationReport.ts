...
function adoptionEnvironment(row: ReleaseLineMigrationReportResponse["adoptions"]["items"][number], t: TFunction): string {
  if (row.environmentScope === "ALL") return t("toadie.adoptions.allEnvironments");
  if (row.environmentScope === "UNKNOWN" || row.environment == null) return t("toadie.adoptions.unknownEnvironment");
  return `${linkedLabel(row.environment.title, row.environment.url)} (${t("contracts.releaseLines.report.identifier")}: ${inlineCode(row.environment.identifier)}; ${t("contracts.releaseLines.report.entityId")}: ${inlineCode(row.environment.entityId)})`;
}
...
export function migrationReportMarkdown(report: ReleaseLineMigrationReportResponse, t: TFunction): string {
  ...
  const adoptionLines = report.adoptions.items.length
    ? report.adoptions.items.map((row) => `### ${linkedLabel(row.title, row.url)}

- ${t("contracts.releaseLines.report.identifier")}: ${inlineCode(row.identifier)}
- ${t("contracts.releaseLines.report.adoptionKind")}: ${t(`contracts.releaseLines.report.adoptionKinds.${row.kind}`)}
- ${t("contracts.releaseLines.report.consumer")}: ${linkedLabel(row.consumer.title, row.consumer.url)} (${t("contracts.releaseLines.report.identifier")}: ${inlineCode(row.consumer.identifier)}; ${t("contracts.releaseLines.report.entityId")}: ${inlineCode(row.consumer.entityId)})
- ${t("contracts.releaseLines.report.target")}: ${linkedLabel(row.target.title, row.target.url)} (${t("contracts.releaseLines.report.identifier")}: ${inlineCode(row.target.identifier)}; ${t("contracts.releaseLines.report.entityId")}: ${inlineCode(row.target.entityId)})
- ${t("contracts.releaseLines.report.environment")}: ${adoptionEnvironment(row, t)}
- ${t("contracts.releaseLines.report.declaredValue")}: ${row.value == null ? t("contracts.releaseLines.report.unknown") : markdownText(row.value)}
- ${t("contracts.releaseLines.report.declarationStatus")}: ${row.status == null ? t("contracts.releaseLines.report.notProvided") : markdownText(row.status)}
- ${t("contracts.releaseLines.report.declaredBy")}: ${row.declaredBy == null ? t("contracts.releaseLines.report.notProvided") : markdownText(row.declaredBy)}
- ${t("contracts.releaseLines.report.verifiedAt")}: ${utc(row.verifiedAt, t)}
- ${t("contracts.releaseLines.report.matchesConsumption")}: ${row.matchesConsumption ? t("contracts.releaseLines.report.yes") : t("contracts.releaseLines.report.no")}

#### ${t("contracts.releaseLines.report.notes")}

${textBlock(row.notes, t)}`)
    : [t(`contracts.releaseLines.report.adoptionAvailability.${report.adoptions.availability}`)];

  return `# ${t("contracts.releaseLines.report.title")}\n\n## ${t("contracts.releaseLines.report.contract")}\n\n- ${t("contracts.releaseLines.report.name")}: ${inlineCode(report.contractName)}\n- ${t("contracts.releaseLines.report.contractId")}: ${report.contractId}\n- ${t("contracts.releaseLines.report.type")}: ${report.contractType}\n- ${t("contracts.releaseLines.report.releaseLine")}: ${report.major}.x\n- ${t("contracts.releaseLines.report.generatedAt")}: ${utc(report.generatedAt, t)}\n- ${t("contracts.releaseLines.report.planUpdatedAt")}: ${utc(report.planUpdatedAt, t)}\n\n## ${t("contracts.releaseLines.report.plan")}\n\n- ${t("contracts.releaseLines.supportStatus")}: ${status}\n- ${t("contracts.releaseLines.deprecatesOn")}: ${value(report.deprecatesOn, t)}\n- ${t("contracts.releaseLines.supportEndsOn")}: ${value(report.supportEndsOn, t)}\n- ${t("contracts.releaseLines.recommendedVersion")}: ${recommendation}\n- ${t("contracts.releaseLines.report.replacement")}: ${replacement}\n\n### ${t("contracts.releaseLines.supportPolicy")}\n\n${textBlock(report.supportPolicy, t)}\n\n### ${t("contracts.releaseLines.migrationGuide")}\n\n${textBlock(report.migrationGuide, t)}\n\n## ${t("contracts.releaseLines.report.usage")}\n\n> ${t("contracts.releaseLines.report.scopeWarning")}\n>\n> ${t("contracts.releaseLines.report.emptyWarning")}${usageWarning}\n\n- ${t("contracts.releaseLines.report.scope")}: ${t("contracts.releaseLines.report.contractScope")}\n- ${t("contracts.releaseLines.report.versionAdoption")}: ${t("contracts.releaseLines.report.runtimeUnknown")}\n- ${t("toadie.usage.connection")}: ${connection}\n- ${t("contracts.releaseLines.report.cacheState")}: ${t(`toadie.status.${cacheState}`)}\n- ${t("contracts.releaseLines.report.refreshing")}: ${report.cache.refreshing ? t("contracts.releaseLines.report.yes") : t("contracts.releaseLines.report.no")}\n- ${t("contracts.releaseLines.report.lastSuccessAt")}: ${utc(report.cache.lastSuccessAt, t)}\n- ${t("contracts.releaseLines.report.lastAttemptAt")}: ${utc(report.cache.lastAttemptAt, t)}\n- ${t("contracts.releaseLines.report.lastError")}: ${value(report.cache.lastErrorCode, t)}\n\n## ${t("contracts.releaseLines.report.linkedApis")}\n\n${links.join("\n")}\n\n## ${t("contracts.releaseLines.report.services")}\n\n${serviceLines.join("\n\n")}\n\n## ${t("contracts.releaseLines.report.adoptions")}\n\n> ${t("contracts.releaseLines.report.adoptionWarning")}\n\n${adoptionLines.join("\n\n")}\n`;
}
