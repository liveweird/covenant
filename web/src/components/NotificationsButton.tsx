...
const TYPE_META: Record<Kind, { icon: typeof IconBell; color: string }> = {
  ...
  VERSION_REVIEW_REQUESTED: { icon: IconMessageCircle, color: "covenant" },
  VERSION_REVIEW_COMMENTED: { icon: IconMessageCircle, color: "gray" },
  VERSION_REVIEW_APPROVED: { icon: IconCheck, color: "teal" },
  VERSION_REVIEW_CHANGES_REQUESTED: { icon: IconAlertTriangle, color: "orange" },
