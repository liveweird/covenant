...
import { IconArrowsDiff, IconDots, IconDownload, IconPencil, IconRefresh, IconTrash } from "@tabler/icons-react";
 ...
 * is editable), and the More menu — Download and Compare for everyone, Re-run checks and Delete
 * (a DRAFT) for writers. Everything but Edit is disabled while the document is being edited:
 * the operations act on the STORED text.
 */
