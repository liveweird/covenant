...
// Device-level "what's new" state for the changelog (like covenant.lang, it survives logout).
...
// useStoredState owns the covenant.viewSettings.* namespace, and this is not view state.
