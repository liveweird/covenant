...
Current migrations are `V1`–`V21`. The foundation below covers `V1`–`V15`; `V16` adds major
...
data untouched, and callers apply explicit `C` collation to its text-array result.
