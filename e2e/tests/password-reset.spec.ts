...
// The full email roundtrip needs the compose stack's Mailpit catcher (http://localhost:8027 —
...
function uniqueEmail(prefix: string): string {
  return `${uniqueText(prefix).toLowerCase().replace(/[^a-z0-9-]/g, "-")}@covenant.local`;
}
