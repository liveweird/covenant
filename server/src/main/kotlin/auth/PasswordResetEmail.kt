...
internal val PASSWORD_RESET_EMAIL_SUBJECT: LocalizedText = LocalizedText(
    en = "Your new Covenant password",
    pl = "Twoje nowe hasło Covenant",
)

private val INTRO = LocalizedText(
    en = "a password reset was requested for your Covenant account, so your previous " +
    ...
    pl = "ktoś poprosił o zresetowanie hasła do Twojego konta Covenant, więc Twoje " +
