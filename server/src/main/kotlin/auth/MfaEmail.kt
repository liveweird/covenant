...
internal val MFA_EMAIL_SUBJECT: LocalizedText = LocalizedText(
    en = "Covenant: your sign-in code",
    pl = "Covenant: twój kod logowania",
)
...
internal fun mfaEmailBody(name: String, code: String, ttlMinutes: Long, language: String): String = buildString {
    val intro = LocalizedText(
        en = "someone — hopefully you — is signing in to your Covenant account. Enter the code " +
        ...
        pl = "ktoś — mamy nadzieję, że Ty — loguje się na Twoje konto Covenant. Wpisz poniższy " +
