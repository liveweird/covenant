 ...
 * [covenantTestClientDefaults], i.e. in every `jsonClient()`/`authedClient()`) validates each
 ...
 * Installed once per test client via [covenantTestClientDefaults]. Throws [AssertionError] from
